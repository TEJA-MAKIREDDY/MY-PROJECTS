...
#Ask the user to enter the specific model name for that company(m-maybach,...) the second function whose name is variant. accordingly to the
#car company name and car model the user should be ask to enetr the variant he would like to choose from petrol and disel. last function display
#function according to the car company, car model name and car variant first its ex-showroom price should display and then its on road price should displayed,
#which is calculated as ex-showroom price+CGST+SGST+insurance. the SGST(%), CGST(%) and the insurance all the 3 have comon value throwout the car showroom.
